...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='cmos.conf'
CONFIGFOLDER='/root/.Cosmos'
COIN_DAEMON='/usr/local/bin/cmosd'
COIN_CLI='/usr/local/bin/cmos-cli'
COIN_REPO='https://github.com/CMOS-Project/Cosmos/releases/download/v1.2.0/cmos-1.2.0-x86_64-linux-gnu.tar.gz'
COIN_NAME='Cosmos'
COIN_PORT=61146
